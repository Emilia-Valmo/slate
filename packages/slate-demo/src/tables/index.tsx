...
class Tables extends React.Component {
    ...
    public onBackspace = (event, change) => {
        const { value } = change;
    ...
    public onDelete = (event, change) => {
        const { value } = change;
        if (value.endOffset !== value.startText.text.length) {
            return;
        }
        event.preventDefault();
        return true;
    ...
    public onDropOrPaste = (event, change) => {
