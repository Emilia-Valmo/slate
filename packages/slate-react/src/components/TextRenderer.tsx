 ...
 */
const TextRenderer = React.memo(function TextRenderer(props: TextRendererProps): React.Node {
...
function shouldComponentUpdate(p: TextRendererProps, n: TextRendererProps): boolean {
